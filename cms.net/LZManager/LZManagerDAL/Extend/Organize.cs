...
namespace LZManager.DAL
{
    ...
    public partial class OrganizeMO : DataManagerBase
    {
        ...
        {
            //const string format = @"SELECT  Ur_id, Ur_loginName, Ur_pass, Ur_name, Ur_department, Ur_addUser, Ur_addTime, Ur_state, Ur_del,Ur_errorlogin,Ur_lockTime,Ur_lockBindIp, Ur_text1, Ur_text2 FROM users {0}";
            const string format = @"SELECT Ur_id, Ur_no, Ur_Name, Ur_UserName, Ur_PassWord, Ur_zone, Ur_people, Ur_Contact, Ur_addTime, Ur_percent, Ur_bankName, Ur_bank, Ur_bankNo, Ur_introducer, Ur_state, Ur_del, Ur_errorlogin, Ur_lockTime, Ur_lockBindIp, Ur_text1, Ur_text2 FROM organize {0}";
            string sql = format;
        ...
        public virtual DataTable GetList(string where, int top, string sort, IEnumerable<DbParameter> para)
        {
            ...
            const string sql = @"SELECT Ur_id, Ur_no, Ur_Name, Ur_UserName, Ur_PassWord, Ur_zone, Ur_people, Ur_Contact, Ur_addTime, Ur_percent, Ur_bankName, Ur_bank, Ur_bankNo, Ur_introducer, Ur_state, Ur_del, Ur_errorlogin, Ur_lockTime, Ur_lockBindIp, Ur_text1, Ur_text2 FROM organize WHERE Ur_del = '0'";
