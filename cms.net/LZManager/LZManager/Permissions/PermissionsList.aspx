<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissionsList.aspx.cs"
    Inherits="LZManager.Permissions.PermissionsList" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
        <tr>
            ...
            <td bgcolor="#e9f2f7">
                <asp:TextBox ID="txtPmname" CssClass="text_input" runat="server" MaxLength="50" Width="50%"></asp:TextBox>
            </td>
            <td bgcolor="#cadee8">
    ...
    <asp:GridView ID="gvPermissions" runat="server" AllowSorting="True" AllowPaging="True"
        PageSize="15" AutoGenerateColumns="False" DataKeyNames="Pm_id,Pm_name" OnRowDataBound="gvPermissions_RowDataBound"
        CellSpacing="1" CssClass="table-box" GridLines="None" BackColor="#E9F2F7" EmptyDataText="<%$ Resources:Resource,No_data %>"
        OnSorting="gvPermissions_Sorting">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Pm_name" HeaderText="<%$ Resources:Resource,function_name %>"
                SortExpression="Pm_name" />
            <asp:BoundField DataField="Pm_state" HeaderText="<%$ Resources:Resource,On_Off %>"
                SortExpression="Pm_state" />
            <asp:BoundField DataField="Ur_name" HeaderText="<%$ Resources:Resource,added_by %>"
                SortExpression="Ur_name" />
            <asp:BoundField DataField="Pm_addTime" HeaderText="<%$ Resources:Resource,added_time %>"
                SortExpression="Pm_addTime" />
        </Columns>
