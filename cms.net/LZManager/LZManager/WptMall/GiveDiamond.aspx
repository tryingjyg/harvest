<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GiveDiamond.aspx.cs" Inherits="LZManager.WptMall.GiveDiamond" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            //alert("进来了这个页面");
            $("#<%=btnGive.ClientID%>").click(function () {
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
            <tr>
                ...
                <td bgcolor="#e9f2f7">
                    <asp:TextBox ID="txtDiamond" CssClass="text_input" runat="server" MaxLength="50"
                        Width="50%"></asp:TextBox>
                </td>
                <td>
                    <asp:Button ID="btnGive" runat="server" CssClass="button_bak" Text="赠送"
                        Height="28px" Width="80px" OnClick="btnGive_Click" />
                </td>
            </tr>
        </table>
