<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MallTChargeList.aspx.cs" Inherits="LZManager.MallCharge.MallTChargeList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="gvUsers" runat="server" AllowSorting="True" AllowPaging="True"
            PageSize="10" AutoGenerateColumns="False" DataKeyNames="invoice_no" OnRowDataBound="gvUsers_RowDataBound"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="invoice_no" HeaderText="平台ID"
                    SortExpression="invoice_no" />
                <asp:BoundField DataField="out_trade_no" HeaderText="订单编号"
                    SortExpression="out_trade_no" />
                <asp:BoundField DataField="up_invoice_no" HeaderText="通道订单编号"
                    SortExpression="up_invoice_no" />
                <asp:BoundField DataField="money" HeaderText="金额"
                    SortExpression="money" />
                 <asp:BoundField DataField="app_id" HeaderText="应用ID"
                    SortExpression="app_id" />
                <asp:BoundField DataField="pay_way" HeaderText="支付方式"
                    SortExpression="pay_way" />
                <asp:BoundField DataField="duid" HeaderText="充值人ID"
                    SortExpression="duid" />
