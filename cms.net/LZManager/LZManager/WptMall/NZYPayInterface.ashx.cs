...
namespace LZManager.WptMall
{
    ...
    /// payInterface 的摘要说明
    /// </summary>
    public class NZYPayInterface : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //context.Response.Write("NZYPayInterface");
            ...
            paratStr.Add("mhtOrderNo", "mhtOrderNo=1506827619126");
            ...
            **/
            ...
            else
            {
                ...
                string payUrl = PayUlity.NZYPay(goodNo, goodName, goodDetail, goodMoney);
