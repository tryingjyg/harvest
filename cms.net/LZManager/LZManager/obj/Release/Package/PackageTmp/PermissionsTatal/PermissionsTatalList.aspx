<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissionsTatalList.aspx.cs"
    Inherits="LZManager.PermissionsTatal.PermissionsTatalList" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
        <tr>
            ...
            <td bgcolor="#e9f2f7" width="23%">
                <asp:TextBox ID="txtPtName" CssClass="text_input" runat="server" MaxLength="50" Width="50%"></asp:TextBox>
            </td>
            <td bgcolor="#cadee8" width="10%">
    ...
    <asp:GridView ID="gvPermissionsTatal" runat="server" AllowSorting="True" AllowPaging="True"
        PageSize="15" AutoGenerateColumns="False" DataKeyNames="Pt_id,Pt_name" OnRowDataBound="gvPermissionsTatal_RowDataBound"
        CellSpacing="1" CssClass="table-box" GridLines="None" BackColor="#E9F2F7" 
        EmptyDataText="<%$ Resources:Resource,No_data %>" onsorting="gvPermissionsTatal_Sorting" 
        onpageindexchanging="gvPermissionsTatal_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Pt_name" HeaderText="<%$ Resources:Resource,Major_function_name %>" SortExpression="Pt_name" />
            <asp:BoundField DataField="Pf_name" HeaderText="<%$ Resources:Resource,platform %>" SortExpression="Pf_name" />
            <asp:BoundField DataField="Pt_state" HeaderText="<%$ Resources:Resource,On_Off %>" SortExpression="Pt_state" />
            <asp:BoundField DataField="Ur_name" HeaderText="<%$ Resources:Resource,added_by %>" SortExpression="Ur_name" />
            <asp:BoundField DataField="Pt_addTime" HeaderText="<%$ Resources:Resource,added_time %>" SortExpression="Pt_addTime" />
        </Columns>
