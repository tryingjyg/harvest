<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdd.aspx.cs" Inherits="LZManager.Users.UserAdd" %>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        <asp:TextBox ID="txtParent" CssClass="text_input" runat="server" Width="50%" MaxLength="50" ReadOnly ="true"></asp:TextBox>
                    </td>
                </tr>
                <%--<tr>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        <asp:TextBox ID="txtZone" CssClass="text_input" runat="server" Width="50%" MaxLength="50" ReadOnly ="true"></asp:TextBox>
                        <font color="red">*</font>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="table_body">
                        <asp:Button ID="btnOK" runat="server" CssClass="button_bak" Text="新增代理" OnClick="btnOK_Click"
