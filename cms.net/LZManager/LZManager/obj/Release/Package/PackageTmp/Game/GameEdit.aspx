<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameEdit.aspx.cs" Inherits="LZManager.Game.GameEdit" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
        <tr>
            ...
            <td class="table_none">
                <asp:TextBox ID="txtGameName" CssClass="text_input" runat="server" Width="50%" MaxLength="50"></asp:TextBox>
                <font color="red">*</font>  <asp:RequiredFieldValidator ID="RequiredFieldValidator0" runat="server" ErrorMessage="必填！" ForeColor="Red" ControlToValidate="txtGameName"
        ...
        <tr>
            <td class="table_body">
                <%=Resources.Resource.game_ID%>:
            </td>
            <td class="table_none">
                <asp:TextBox ID="txtGaameId" CssClass="text_input" runat="server" Width="50%" MaxLength="50"></asp:TextBox>
                <font color="red">*</font>
            </td>
        </tr>
        <tr>
            <td class="table_body">
                <%=Resources.Resource.Game_description%>:
            </td>
            <td class="table_none">
        ...
        <tr>
            <td class="table_body">
                <%=Resources.Resource.Game_channel%>：
            </td>
            <td class="table_none">
                <asp:CheckBoxList ID="cblChannel" runat="server" RepeatDirection="Horizontal" RepeatColumns="5">
                </asp:CheckBoxList>
            </td>
        </tr>
        <tr>
