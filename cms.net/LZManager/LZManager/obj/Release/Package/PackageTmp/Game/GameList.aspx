<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameList.aspx.cs" Inherits="LZManager.Game.GameList" %>
...
<body>
    ...
    <asp:GridView ID="gvGame" runat="server" AllowSorting="True" AllowPaging="True" PageSize="15"
        AutoGenerateColumns="False" DataKeyNames="Gm_gameId,Gm_name" OnRowDataBound="gvGame_RowDataBound"
        CellSpacing="1" CssClass="table-box" GridLines="None" BackColor="#E9F2F7" EmptyDataText="<%$ Resources:Resource,No_data %>"
        OnSorting="gvGame_Sorting" Width="100%" OnPageIndexChanging="gvGame_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Gm_name" HeaderText="<%$ Resources:Resource,game_name %>"
                SortExpression="Gm_name" />
            <asp:BoundField DataField="Gm_gameId" HeaderText="<%$ Resources:Resource,game_ID %>"
                SortExpression="Gm_gameId" />
            <asp:TemplateField HeaderText="<%$ Resources:Resource,channel_name %>" SortExpression="Cn_name">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# BindChannelID(Eval("Gm_gameId")) %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="Gm_state" HeaderText="<%$ Resources:Resource,On_Off %>"
                SortExpression="Gm_state" />
            <asp:BoundField DataField="Ur_name" HeaderText="<%$ Resources:Resource,added_by %>"
                SortExpression="Ur_name" />
            <asp:BoundField DataField="Gm_adddTime" HeaderText="<%$ Resources:Resource,added_time %>"
                SortExpression="Gm_adddTime" />
        </Columns>
